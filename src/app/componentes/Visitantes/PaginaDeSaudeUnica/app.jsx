        ...
        >
          <div className={styles.painel}>
            <p>
              A{" "}
              <strong>
                Saúde Única é uma abordagem integrada e interdisciplinar
                proposta por organizações internacionais,
              </strong>{" "}
              como a Organização Mundial da Saúde &#40;OMS&#41;, a Organização
              Mundial da Saúde Animal &#40;OIE&#41; e a Organização das Nações
              Unidas para Alimentação e Agricultura &#40;FAO&#41;,{" "}
              <strong>
                que reconhece que a saúde humana, a saúde animal e a saúde
                ambiental estão interligadas
              </strong>
              . Ou seja, para garantir a saúde das pessoas, é necessário também
              cuidar dos animais e do meio ambiente.
            </p>
          </div>
          <img src={`${import.meta.env.BASE_URL}pagSaudeUnica/arvore.png`} />
        </section>
